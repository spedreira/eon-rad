...
SECRET_KEY = '#3af!vekc^6yin36re=b3dz*&!z@yvi=$w065p_%=9lobcg-$='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DEBUG_VALUE') == 'True')

ALLOWED_HOSTS = ['posteoswebapp.herokuapp.com']
...
LOGIN_REDIRECT_URL = 'posteos-home'
LOGIN_URL = 'login'
